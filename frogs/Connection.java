...
public class Connection implements Runnable 
{
	...
	{
		String clientInput;
		Logger.printMsg(this, "Connected.");
		...
		try
		{
			while (this.keepRunning) 
			{
				...
				int tmp;
				String tmpStr = "";
				//InputStreamReader isr = new InputStreamReader(this.cs.getInputStream());
...
//				}
				...
				if(clientInput.contains("\0")) break;
				//System.out.println(clientInput);
		...
		{ 
			...
			Logger.printMsg(this, "Exception caused by timeout.");
		}
		catch (IOException e) 
		{ 
			connManager.notifyErrorEvent(this);
			Logger.printMsg(this, "I/O Exception occur."); 
		}
		catch (Exception e)
		{
			e.printStackTrace();
			connManager.notifyErrorEvent(this);
			Logger.printMsg(this, "Unknown Error.");
		}
		
		connManager.notifyDisconnectEvent(this);
		Logger.printMsg(this, "Terminated.");
	}	
}