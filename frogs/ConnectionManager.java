...
public class ConnectionManager 
{
	...
	public void bindConnection(Socket cs)
	{
		synchronized(connections) 
		{
			...
			{ 
				accept = false; 
				Logger.printMsg(this,"System encountered a socket exception and connection fails to establish.");
			}
	...
	public void broadcastMessage(String msg)
	{
		synchronized(connections) 
		{
			...
			while(e.hasMoreElements())
			{
				...
				{
					Logger.printMsg(this,"Null connection ID detected. That connection should be already disconnected.");
				}
			}
		}
	}
