...
public class ChessGameManager 
{
	...
	protected final Hashtable<Integer, Channel> games;
	...
	{
		games = new Hashtable<Integer, Channel>(10);
	}
	...
	public int buildGame(String gameName, String gameDesc, String creator, String fileName)
	{
		...
		//	Channel game = new Channel(gID, gameName, gameDesc, creator, chess);
		//	games.put(gID, game);
			return gID;
		//}
		//else
	...
	public boolean removeGame(Channel game)
	{
		synchronized (games)
		{
	...
	public Channel getGame(int gameID)
	{
	...
	public void notifyJoinEvent(Channel game, int connID)
	{
	...
	public void notifyStartEvent(Channel game)
	{
		String msg = "Game "+game.getName() + " started.";
		Logger.printMsg("GameManager", msg);
		String responseMsg = Logger.responseMsg("game_event", "<start/><msg>"+msg+"</msg>");
		connManager.multicastMessage(game.getConnectionIDList(), responseMsg);	
	}
	
	public void notifyTerminateEvent(Channel game)
	{
		String msg = "Game "+game.getName() + " terminated.";
		Logger.printMsg("GameManager", msg);
		String responseMsg = Logger.responseMsg("game_event", "<terminate/><msg>"+msg+"</msg>");
		connManager.multicastMessage(game.getConnectionIDList(), responseMsg);	
	}
	
	public void notifyTurnEvent(Channel game)
	{
	...
	public void notifyWinEvent(Channel game, String who)
	{
	...
	public void notifyLoseEvent(Channel game, String who)
	{
		String winner = game.getCurrentPlayerConnection().getUsername();
